...
<head>
  ...
  <title>Dashboard Reseller OESMAN</title>
  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4 mb-5">
      <div class="col-12 text-center text-sm-center mb-0">
        ...
        <br>
        <h3 class="page-title mt-4" >PILIHAN MENU</h3>
    </div>
  </div>
...
<div class="row">
  <div class="col-lg col-md-6 col-sm-6 mb-4" data-aos="flip-left" data-aos-duration="500" data-aos-easing="ease-in-out">
    ...
    <div class="stats-small stats-small--1 card card-small">
      <!-- data satu -->
        <a class="card-body p-0 d-flex" href="edit-profil-reseller-test.php?id=<?php echo $_SESSION['id']; ?>" data-toggle="" data-target="">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
              <i class="fas fa-user" style="font-size:48px; color: #570000;"></i>
              <span class="stats-small__label text-uppercase">EDIT PROFILE</span>
            </div>
          </div>
        </a> 
      </div> 
    </div>
    <div class="col-lg col-md-6 col-sm-6 mb-4" data-aos="flip-left" data-aos-delay="100" data-aos-duration="500"
    data-aos-easing="ease-in-out">
    <div class="stats-small stats-small--1 card card-small">
      <!-- data dua -->
        <a class="card-body p-0 d-flex" href="" data-toggle="" data-target="">
          <div class="d-flex flex-column m-auto">
            <div class="stats-small__data text-center">
            <i class="fas fa-shopping-bag" style="font-size:48px; color: #570000;"></i>
              <span class="stats-small__label text-uppercase">STATUS ORDER</span>
            </div>
          </div>
        </a>
      </div>
    ...
    <div class="stats-small stats-small--1 card card-small">
        <!-- data tiga -->
      <a class="card-body p-0 d-flex" href="" >
        <div class="d-flex flex-column m-auto">
          <div class="stats-small__data text-center">
            <i class="fas fa-star" style="font-size:48px; color: #570000;"></i>
            <span class="stats-small__label text-uppercase">CLAIM BONUS</span>
          </div>
        </div>
      </a>
    </div>
...
<div class="col text-right view-report">
  <h5><a href="logout-reseller.php"> <i class="fas fa-sign-out-alt" style="font-weight: 48px;"></i> Logout </a></h5>
</div>
